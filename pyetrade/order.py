...
@ProcessResult('getOrderListResponse')
def list_orders(account_id):
    ...
    """
    assert isinstance(account_id, int)
    return requests.get(etrade_url.orders_list(account_id), auth=auth.current)
...
def equity_order_preview(equity_order_props):
    ...
    return requests.post(etrade_url.orders_equity_preview, json=data, auth=auth.current)
...
def equity_order_place(equity_order_props):
    ...
    return requests.post(etrade_url.orders_equity_place, json=data, auth=auth.current)
...
def equity_change_preview(equity_order_change_props):
    ...
    return requests.post(etrade_url.orders_equity_change_preview, json=data, auth=auth.current)
...
def equity_change_place(equity_order_change_props):
    ...
    return requests.post(etrade_url.orders_equity_change_place, json=data, auth=auth.current)
...
def option_order_preview(option_order_props):
    ...
    return requests.post(etrade_url.orders_option_preview, json=data, auth=auth.current)
...
def option_order_place(option_order_props):
    ...
    return requests.post(etrade_url.orders_option_place, json=data, auth=auth.current)
...
def option_change_preview(option_change_props):
    ...
    return requests.post(etrade_url.orders_option_change_preview, json=data, auth=auth.current)
...
def option_change_place(option_change_props):
    ...
    return requests.post(etrade_url.orders_option_change_place, json=data, auth=auth.current)


@ProcessResult('cancelOrderResponse')
def cancel_order(account_id, order_id):
    ...
    return requests.post(etrade_url.orders_cancel, json=data, auth=auth.current)
